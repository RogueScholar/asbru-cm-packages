...
PACKAGE_DIR="./tmp"
ORIG_PACKAGE_NAME="Gtk2-Unique-0.05"
PACKAGE_NAME="libgtk2-unique-perl_0.05"
PACKAGE_SRC="https://cpan.metacpan.org/authors/id/P/PO/POTYL/${ORIG_PACKAGE_NAME}.tar.gz"
